...
{
	uint8_t check, data;
	HAL_I2C_Mem_Read(&hi2c3, MPU6050_ADDR, WHO_I_AM_REG,1,&check,1,1000);
	if (check == 104) // if the device is present
	{
		// Power management register 0x6B we should write all 0's to wake up sensor
		data = 0;
